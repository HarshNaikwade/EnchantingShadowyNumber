...
const statusVariant: Record<string, 'default' | 'success' | 'warning' | 'danger' | 'review' | 'secondary'> = {
  completed: 'success',
  processing: 'warning',
  pending: 'secondary',
  failed: 'danger',
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Local Agreement Analysis System</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <OllamaStatusBar />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground mt-1">
            Upload legal agreements and analyze them against RBI compliance standards.
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 border-2 border-dashed border-border rounded-xl">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Analysis Sessions Yet</h3>
            <p className="text-muted-foreground mb-4 max-w-sm mx-auto">
              Create your first analysis session to start checking agreements against RBI compliance standards.
            </p>
            <Button onClick={() => setShowCreate(true)}>
              <Plus className="h-4 w-4 mr-2" />
              Create New Analysis
              ...
              >
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    ...
                    <Badge variant={statusVariant[session.status] || 'secondary'} className="ml-2 shrink-0 capitalize">
                      {session.status}
                    </Badge>
                  </div>
