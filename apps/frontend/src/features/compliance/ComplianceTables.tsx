                ...
                filteredRBI.map((clause, i) => (
                  ...
                  >
                    ...
                    <TableCell className="text-xs max-w-xs">
                      {clause.category && (
                        <span className="inline-block text-xs font-medium text-primary bg-primary/10 rounded px-1.5 py-0.5 mb-1">
                          {clause.category}
                        </span>
                      )}
              ...
              <TableRow className="bg-slate-800 hover:bg-slate-800">
                ...
                >
                  <div className="flex items-center gap-1">
                    Compliance Status <ArrowUpDown className="h-3 w-3" />
                  </div>
                </TableHead>
                <TableHead
                  className="text-white font-semibold cursor-pointer select-none"
